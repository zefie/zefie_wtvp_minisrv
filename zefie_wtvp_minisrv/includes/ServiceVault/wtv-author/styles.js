  ...
  <table cellspacing=0 cellpadding=0 height=385>
    ...
    <tr>
      ...
      <td abswidth=93 absheight=26>
        <table href="wtv-guide:/help?topic=Publish&subtopic=Index&appName=Page%20Builder" cellspacing=0 cellpadding=0>
          <tr>
            <td abswidth=5>
...
<body bgcolor=#1e4261 background=wtv-author:/ROMCache/blue_tile_128.gif text=AEBFD1 link=B8BDC7 vlink=B8BDC7 hspace=0 vspace=0>
  <table cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=0#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
            </td>
            <td align=center>
              <font color=D1D1D1>
            ...
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=2#plus" id=plus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/plus_button.gif">
              </table>
            </td>
          </tr>
        </table>
    ...
    <tr>
      <td colspan=5>
        <font color=AEBFD1> Your current style is: <b>${styleName}</b>
        </font>
    <tr>
      <td absheight=5>
    <tr>
      <td>
        <TABLE border=0 cellpadding=0 cellspacing=0 width=137>
          <TR height=120>
            <TD width=128 height=120 bgcolor=#8A99B0 href="save-style?docName=${docName}
&layoutTMPL=
Blue.tmpl&contentTMPL=&styleName=Blue
&blocksPerPage=0" name="Blue
">
...
&blocksPerPage=0" name="Green
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Green <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Tan
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Tan <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Grey
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Grey <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Rivets
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Rivets <BR>
              </font>
              <center>
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=1#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
            ...
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=3#plus" id=plus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/plus_button.gif">
              </table>
...
&blocksPerPage=0" name="Football
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Football <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Baseball
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Baseball <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Christmas
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Christmas <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Channukah
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Channukah <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Easter
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Easter <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Halloween
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Halloween <BR>
              </font>
              <center>
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=2#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
            ...
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=4#plus" id=plus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/plus_button.gif">
              </table>
...
&blocksPerPage=0" name="Democratic
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Democratic <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Republican
">
              <spacer type=block width=4></spacer>
...
&blocksPerPage=0" name="Flowers
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Flowers <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="It's a Girl
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> It's a Girl <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="It's a Boy
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> It's a Boy <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Wedding
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Wedding <BR>
              </font>
              <center>
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=3#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
            ...
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=5#plus" id=plus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/plus_button.gif">
              </table>
...
&blocksPerPage=0" name="New Wave
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> New Wave <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Eyeballs
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Eyeballs <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="American
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> American <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="South Beach
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> South Beach <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Paisley
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Paisley <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Green Paper
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Green Paper <BR>
              </font>
              <center>
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=4#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
...
&blocksPerPage=0" name="Water
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Water <BR>
              </font>
              <center>
...
&blocksPerPage=0" name="Marble
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Marble <BR>
              </font>
              <center>
      ...
      <td>
        <TABLE border=0 cellpadding=0 cellspacing=0 width=137>
          <TR height=120>
            <TD width=128 height=120 bgcolor=#8A99B0 href="save-style?docName=${docName}
&layoutTMPL=Business.tmpl&contentTMPL=&styleName=Finance&blocksPerPage=0" name="Finance">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Finance <BR>
              </font>
              <center>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            ...
            <td>
              <table cellspacing=0 cellpadding=0 ref="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName}&pageNum=1#plus" id=plus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/plus_button_dim.gif">
              </table>
...
&blocksPerPage=0" name="Blue Sands
">
              <spacer type=block width=4></spacer>
    ...
    <tr>
      <td>
        <TABLE border=0 cellpadding=0 cellspacing=0 width=137>
          <TR height=120>
            <TD width=128 height=120 bgcolor=#8A99B0 href="save-style?docName=${docName}
&layoutTMPL=Blue.tmpl&contentTMPL=&styleName=Blue
&blocksPerPage=0" name="Blue
">
              <spacer type=block width=4></spacer>
              <font color=0F283F> Blue <BR>
  ...
  <table cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=&styleName=&pageNum=0#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
            ...
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=&styleName=&pageNum=2#plus" id=plus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/plus_button.gif">
              </table>
    ...
    <tr>
      <td>
        <TABLE border=0 cellpadding=0 cellspacing=0 width=137>
          <TR height=120>
            <TD width=128 height=120 bgcolor=#8A99B0 href="new?tmplClass=11
&layoutTMPL=
Blue.tmpl&contentTMPL=&styleName=Blue
&blocksPerPage=0" name="Blue
">
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=&styleName=&pageNum=1#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
            ...
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=&styleName=&pageNum=3#plus" id=plus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/plus_button.gif">
              </table>
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=&styleName=&pageNum=2#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
            ...
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=&styleName=&pageNum=4#plus" id=plus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/plus_button.gif">
              </table>
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=&styleName=&pageNum=3#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
            ...
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=&styleName=&pageNum=5#plus" id=plus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/plus_button.gif">
              </table>
    ...
    <tr>
      ...
      <td align=right valign=middle>
        <table valign=middle>
          <tr>
            <td>
              <table cellspacing=0 cellpadding=0 href="wtv-author:/styles?tmplClass=11&docName=&styleName=&pageNum=4#minus" id=minus>
                <tr>
                  <td>
                    <img src="wtv-author:/ROMCache/minus_button.gif">
              </table>
  ...
  <table cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr>
      <td>
        <TABLE border=0 cellpadding=0 cellspacing=0 width=137>
          <TR height=120>
            <TD width=128 height=120 bgcolor=#8A99B0 href="new?tmplClass=
&layoutTMPL=Blue_Sands.tmpl&contentTMPL=&styleName=Blue Sands
&blocksPerPage=0" name="Blue Sands
">
              <spacer type=block width=4></spacer>
...
">
              ...
              <center>
                <img src=/images/styles/Spaceic.gif width="120" height="90" vspace=3>
              </center>
            </TD>
            <TD height=120>
              <IMG height=120 width=12 src=/ROMCache/right_shadow.gif>
